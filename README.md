...
- [x] SEO: per-page meta tags, JSON-LD (Event [index/competition + workshop, both date-gated] + Organization + BreadcrumbList), locale-aware sitemap (6 EN + 6 zh URLs published), alt text + width/height on every img
